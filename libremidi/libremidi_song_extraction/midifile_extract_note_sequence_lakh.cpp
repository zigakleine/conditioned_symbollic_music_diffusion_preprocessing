    ...
    if(midi_block.time_signature_1 == 4 && midi_block.time_signature_2 == 4){
      ...
      if(block_measures >= sequence_length_measures){
        ...
        for(int i = 0; i < num_of_blocks_to_add; i++){
          int this_block_division_start = this_block_start + sequence_length_measures*96*i;
          int this_block_division_end = this_block_start + sequence_length_measures*96*(i+1);
